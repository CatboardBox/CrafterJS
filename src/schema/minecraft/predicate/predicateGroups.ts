...
type MappedPredicateConditions = {
...
export type FilteredPredicateConditions<T extends SubLootContext[]> = {
  [K in keyof MappedPredicateConditions]: AreAllSubtypesPresent<MappedPredicateConditions[K], T> extends true ? K : never;
}[keyof MappedPredicateConditions];
